...
| `/apply/[productId]` | `POST /api/cases`, `PATCH /api/cases/drafts/{id}`, `POST /api/documents/upload`, `POST /api/documents/scan-passport`, checkout |
| `/status/[caseId]` | `GET /api/cases/{case_id}/status`, document resubmit |
| `/account` | `GET/PATCH /api/customers/me`, traveler-profiles, document-vault |
